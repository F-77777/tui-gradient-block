...
lazy_static! {
    ...
    pub static ref RUSTY_RUINS: GradientThemeSet = GradientThemeSet {
        bottom_right: generate_gradient_theme!(BorderGradients {
            top: vec![COLOR_1, COLOR_1],
            top_fac: 1.0,
            left: vec![COLOR_1, COLOR_1],
            left_fac: 1.0,
            bottom: vec![COLOR_1, COLOR_2, COLOR_3],
            bottom_fac: 1.0,
            right: vec![COLOR_1, COLOR_2, COLOR_3],
            right_fac: 1.0,
        }),
        bottom_left: generate_gradient_theme!(BorderGradients {
            top: vec![COLOR_1, COLOR_1],
            top_fac: 1.0,
            left: vec![COLOR_1, COLOR_2, COLOR_3],
            left_fac: 1.0,
            bottom: vec![COLOR_3, COLOR_2, COLOR_1],
            bottom_fac: 1.0,
        ...
        double_right: generate_gradient_theme!(BorderGradients {
            ...
            bottom: vec![COLOR_3, COLOR_2, COLOR_1],
            bottom_fac: 1.0,
            right: vec![COLOR_3, COLOR_2, COLOR_1],
            right_fac: 1.0,
        }),
        double_left: generate_gradient_theme!(BorderGradients {
            top: vec![COLOR_3, COLOR_2, COLOR_1],
            top_fac: 1.0,
            left: vec![COLOR_3, COLOR_2, COLOR_1],
            left_fac: 1.0,
            bottom: vec![COLOR_1, COLOR_2, COLOR_3],
            bottom_fac: 1.0,
            right: vec![COLOR_1, COLOR_2, COLOR_3],
        ...
        top_right: generate_gradient_theme!(BorderGradients {
            top: vec![COLOR_1, COLOR_2, COLOR_3],
            top_fac: 1.0,
            left: vec![COLOR_1, COLOR_1],
            left_fac: 1.0,
            bottom: vec![COLOR_1, COLOR_1],
        ...
        double_horizontal: generate_gradient_theme!(
            BorderGradients {
                top: vec![
                    COLOR_1, COLOR_2, COLOR_3, COLOR_2, COLOR_1
                ],
                top_fac: 1.0,
                left: vec![
        ...
        double_vertical: generate_gradient_theme!(BorderGradients {
            ...
            left: vec![
                ...
                COLOR_3,
                get_transformed_rgb!(COLOR_2, 0.9, 2),
                COLOR_1
            ],
            left_fac: 1.0,
            bottom: vec![COLOR_1, COLOR_1],
        ...
        up: generate_gradient_theme!(BorderGradients {
            top: vec![
                get_transformed_rgb!(COLOR_2, 1.1, 1),
                get_transformed_rgb!(COLOR_2, 1.1, 1)
            ],
            top_fac: 1.0,
            left: vec![
        ...
        base1: generate_gradient_theme!(BorderGradients {
            top: vec![COLOR_1, COLOR_2, COLOR_3, COLOR_2],
            top_fac: 1.0,
            left: vec![COLOR_1, COLOR_2],
            left_fac: 1.0,
        ...
        base2: generate_gradient_theme!(BorderGradients {
            ...
            left_fac: 1.0,
            bottom: vec![COLOR_2, COLOR_2, COLOR_2],
            bottom_fac: 1.0,
            right: vec![COLOR_2, COLOR_1, COLOR_2],
            right_fac: 1.0,
        }),
    };
}
