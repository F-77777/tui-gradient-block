...
pub const MISC1: BorderSymbolsSet = BorderSymbolsSet {
    top_left: Some('+'),
    bottom_left: Some('+'),
    top_right: Some('+'),
    bottom_right: Some('+'),
...
pub const MISC2: BorderSymbolsSet = BorderSymbolsSet {
    top_left: Some('&'),
    bottom_left: Some('&'),
    top_right: Some('&'),
    bottom_right: Some('&'),
...
pub const MISC3: BorderSymbolsSet = BorderSymbolsSet {
    top_left: Some('╬'),
    bottom_left: Some('╬'),
    top_right: Some('╬'),
    bottom_right: Some('╬'),
...
pub const MISC4: BorderSymbolsSet = BorderSymbolsSet {
    top_left: Some('$'),
    bottom_left: Some('$'),
    top_right: Some('$'),
    bottom_right: Some('$'),
